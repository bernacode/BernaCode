...
<div align="center">
  <blockquote>
    <br>
    <strong>ES:</strong> Ingeniero y Desarrollador apasionado por la evolución técnica. Me especializo en adoptar y dominar nuevas herramientas para afrontar desafíos desde cualquier ángulo tecnológico. Actualmente enfocado en el aprendizaje de <strong>Ciberseguridad</strong> y desarrollando soluciones completas de gestión.
    <br><br>
    <strong>EN:</strong> Engineer & Developer passionate about technical evolution. I specialize in adopting and mastering new tools to tackle challenges from any technological angle. Currently focused on learning <strong>Cybersecurity</strong> and developing comprehensive management solutions.
    <br><br>
  </blockquote>
</div>
